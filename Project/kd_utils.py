...
#  14. Trainer           - loops de treino das 3 fases
#  15. Evaluator         - avaliacao final e metricas de eficiencia
#  16. plotar_curvas, plotar_comparacao_mse_rkd, plotar_graficos_analise
...
class Trainer:
    ...
    def treinar_fase2(self, student, teacher, loader_train, loader_val, perda_fn,
        ...
        for epoch in range(1, n_epochs + 1):
            ...
            acc_vl = self.validar_student(student, teacher, loader_val, modo_target)
            scheduler.step()
